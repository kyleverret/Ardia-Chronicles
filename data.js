...
const REPORTERS = [
  {
    ...
    bio: "A veteran of twenty years covering the halls of the Grand Council, Lyra Stormweave has broken some of Ardia Prime's most consequential political stories. Born in the coastal city of Valdris, she studied political science at the Praxis Academy before joining the Chronicle. She is known for her unrelenting pursuit of the truth and her deep network of sources within the Council chambers.",
    avatar: "LS",
    avatarColor: "#7b2fff",
  ...
  },
  {
    ...
    bio: "Elara Sunforge came from a family of merchant traders and understands the ebb and flow of Ardia Prime's economy from the ground up. She has a gift for translating the complex movements of crystal markets, shipping guild contracts, and banking guild politics into language that every citizen can understand. Under her tenure, the Business desk has expanded to include a dedicated Magitech Markets section.",
    avatar: "ES",
    avatarColor: "#c9a227",
...
const STORIES = [
  ...
  },
  {
    ...
    "subheadline": "Ardia Prime faces potential power shortages as largest arcane crystal supplier suspends extraction. Prices surge 40% in morning trading.",
